-- filename: create_and_load_lar_2005.sql

DROP TABLE IF EXISTS hmda_public.lar_2005;
CREATE TABLE hmda_public.lar_2005(   
...
FROM '/Users/connor/Desktop/GithubProjects/propval-wui/sorting-wui/Raw_data/HMDA/data/lar/lar_2005.dat';

COMMIT;

INSERT INTO hmda_public.lar_2005 (
    activity_year,
    respondent_id,
    agency_code,
    loan_type,
