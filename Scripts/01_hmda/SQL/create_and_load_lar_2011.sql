...
DROP TABLE IF EXISTS hmda_public.lar_2011;
CREATE TABLE hmda_public.lar_2011(   
...
FROM '/Users/connor/Desktop/GithubProjects/propval-wui/sorting-wui/Raw_data/HMDA/data/lar/lar_2011.dat';

COMMIT;

INSERT INTO hmda_public.lar_2011 (
    activity_year,
    respondent_id,
    agency_code,
    loan_type,
