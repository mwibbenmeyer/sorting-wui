...
PASSWORD="sortingproject" #user's password for the connection
...
echo "creating HMDA LAR tables for 2002-2017"
psql $PGDATABASE $PGUSER << EOF
	\c hmda;
	set schema 'hmda_public';
	\i 'SQL/create_and_load_lar_2002.sql'
	\i 'SQL/create_and_load_lar_2003.sql'
