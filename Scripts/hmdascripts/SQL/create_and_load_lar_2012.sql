...
DROP TABLE IF EXISTS hmda_public.lar_2012;
CREATE TABLE hmda_public.lar_2012(   
...
FROM '/Users/connor/Desktop/GithubProjects/propval-wui/sorting-wui/Raw_data/HMDA/data/lar/lar_2012.dat';

COMMIT;

INSERT INTO hmda_public.lar_2012 (
    activity_year,
    respondent_id,
    agency_code,
    loan_type,
