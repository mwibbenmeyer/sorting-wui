...
DROP TABLE IF EXISTS hmda_public.lar_2003;
CREATE TABLE hmda_public.lar_2003(   
...
FROM '/Users/connor/Desktop/GithubProjects/propval-wui/sorting-wui/Raw_data/HMDA/data/lar/lar_2003.dat';

COMMIT;

INSERT INTO hmda_public.lar_2003 (
    activity_year,
    respondent_id,
    agency_code,
    loan_type,
