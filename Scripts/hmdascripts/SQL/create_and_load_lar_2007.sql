...
DROP TABLE IF EXISTS hmda_public.lar_2007;
CREATE TABLE hmda_public.lar_2007(   
...
FROM '/Users/connor/Desktop/GithubProjects/propval-wui/sorting-wui/Raw_data/HMDA/data/lar/lar_2007.dat';

COMMIT;

INSERT INTO hmda_public.lar_2007 (
    activity_year,
    respondent_id,
    agency_code,
    loan_type,
